...
class QdrantAdapter(BenchmarkAdapter):
    ...
    def run(self, dataset: DatasetBundle, config: RunConfig) -> dict[str, Any]:
        ...
        try:
            ...
            disk_bytes_after_ingest = _directory_bytes(os.environ.get("BENCH_QDRANT_STORAGE_DIR"))
            recalls = []
            ndcgs = []
            mrrs = []
            ...
            disk_bytes_after_workload = _directory_bytes(os.environ.get("BENCH_QDRANT_STORAGE_DIR"))
