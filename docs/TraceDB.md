...
not retry those routes unless `TraceDbClientConfig::with_idempotency_retries` is
also enabled. The SDK also exposes typed local admin helpers for compact,
snapshot, and restore. SQL compatibility remains unimplemented.
